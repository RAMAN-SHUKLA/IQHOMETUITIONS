...
export const SUBJECTS: Subject[] = [
  ...
  },
  {
    ...
    seoContent: "Accounts tuition in Kanpur. Master Double Entry Bookkeeping, Ledger, Journal, and Financial Statements with our experienced home tutors.",
  },
  {
    id: 10,
    ...
    boards: ["CBSE", "ICSE", "UP Board"],
    seoContent: "Get expert computer teachers and programming/coding classes in Kanpur. Learn Python, Java, C++, and school computer science concepts.",
  },
  {
    id: 11,
    name: "CUET Coaching",
    slug: "cuet",
    category: "competitive",
    classes: ["Class 12", "Droppers"],
    boards: ["CBSE", "ICSE", "UP Board"],
    seoContent: "Top CUET coaching in Kanpur. Prepare for Central University Entrance Test with our specialized home tutors.",
  },
  {
    id: 12,
    name: "NDA Coaching",
    ...
    classes: ["Class 11-12", "Droppers"],
    boards: ["CBSE", "UP Board"],
    seoContent: "Pass the National Defence Academy exam with Kanpur's leading NDA home coaches.",
  },
  {
    id: 13,
    name: "SSC Coaching",
    slug: "ssc",
    category: "competitive",
    classes: ["College Students", "Graduates"],
    boards: ["General"],
    seoContent: "Crack Staff Selection Commission exams with personalized SSC coaching in Kanpur.",
  },
];
